...
function list_choiceRoutineBegin(snapshot) {
  return async function () {
    ...
    list_choiceComponents.forEach( function(thisComponent) {
...
function loop_tutorial_01LoopBegin(loop_tutorial_01LoopScheduler, snapshot) {
  return async function() {
    ...
    loop_tutorial_01.forEach(function() {
...
function loop_tutorial_02LoopBegin(loop_tutorial_02LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loop_tutorial_02.forEach(function() {
...
function loop_tutorial_04LoopBegin(loop_tutorial_04LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loop_tutorial_04.forEach(function() {
...
function loop_practiceLoopBegin(loop_practiceLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loop_practice.forEach(function() {
...
function alien_practiceLoopBegin(alien_practiceLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    alien_practice.forEach(function() {
...
function TUTORIAL_01RoutineBegin(snapshot) {
  return async function () {
    ...
    TUTORIAL_01Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_01RoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_01Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_01_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_01_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUTORIAL_02RoutineBegin(snapshot) {
  return async function () {
    ...
    TUTORIAL_02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_02RoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_02_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_02_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUTORIAL_3_1RoutineBegin(snapshot) {
  return async function () {
    ...
    TUTORIAL_3_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUTORIAL_3_2RoutineBegin(snapshot) {
  return async function () {
    ...
    TUTORIAL_3_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_03RoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_03Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRY_03_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    TRY_03_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUTORIAL_04RoutineBegin(snapshot) {
  return async function () {
    ...
    TUTORIAL_04Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function count_practice_goldRoutineBegin(snapshot) {
  return async function () {
    ...
    count_practice_goldComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PRACTICE_rocketRoutineBegin(snapshot) {
  return async function () {
    ...
    PRACTICE_rocketComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PRACTICE_rocket_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    PRACTICE_rocket_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PRACTICE_alienRoutineBegin(snapshot) {
  return async function () {
    ...
    PRACTICE_alienComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PRACTICE_alien_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    PRACTICE_alien_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_22RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_22Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_23RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_23Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_24RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_24Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_25RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_25Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_26RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_26Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_27RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_27Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TUT_28RoutineBegin(snapshot) {
  return async function () {
    ...
    TUT_28Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EXP_rocketRoutineBegin(snapshot) {
  return async function () {
    ...
    EXP_rocketComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EXP_rocket_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    EXP_rocket_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EXP_alienRoutineBegin(snapshot) {
  return async function () {
    ...
    EXP_alienComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EXP_alien_selectionRoutineBegin(snapshot) {
  return async function () {
    ...
    EXP_alien_selectionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function total_goldRoutineBegin(snapshot) {
  return async function () {
    ...
    total_goldComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function transition_to_postRoutineBegin(snapshot) {
  return async function () {
    ...
    transition_to_postComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function post_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    post_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PROBERoutineBegin(snapshot) {
  return async function () {
    ...
    if ((static_probability_left > static_probability_right)) {
    ...
    if ((static_probability_right > static_probability_left)) {
        if ((key_resp_probe.keys === "m")) {
            accuracy = 1;
        } else {
            if ((key_resp_probe.keys === "x")) {
